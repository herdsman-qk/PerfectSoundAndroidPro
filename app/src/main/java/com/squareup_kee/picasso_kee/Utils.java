...
import static com.squareup_kee.picasso_kee.Picasso_kee.TAG;
    ...
    static int getResourceId(Resources resources, Request data) throws FileNotFoundException {
        ...
        if (segments == null || segments.isEmpty()) {
            ...
            try {
                ...
                throw new FileNotFoundException("Last path segment is not a resource lll11l1ll1l1lll1ll1l: " + data.uri);
            }
