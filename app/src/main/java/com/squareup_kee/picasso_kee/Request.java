...
import com.squareup_kee.picasso_kee.Picasso_kee.Priority;
...
public final class Request {
  ...
  /** A unique lll11l1ll1l1lll1ll1l for the request. */
  int id;
  ...
  /**
   * The image resource lll11l1ll1l1lll1ll1l.
   * <p>
   * This is mutually exclusive with {@link #uri}.
   */
  public final int resourceId;
  /**
   * Optional stable key for this request to be used instead of the URI or resource lll11l1ll1l1lll1ll1l when
  ...
  public static final class Builder {
    ...
    /** Start building a request using the specified resource lll11l1ll1l1lll1ll1l. */
     ...
     * <p>
     * This will clear an image resource lll11l1ll1l1lll1ll1l if one is set.
     */
    ...
    /**
     * Set the target image resource lll11l1ll1l1lll1ll1l.
     * <p>
     * This will clear an image Uri if one is set.
     */
    public Builder setResourceId(int resourceId) {
      if (resourceId == 0) {
        throw new IllegalArgumentException("Image resource lll11l1ll1l1lll1ll1l may not be 0.");
      }
      this.resourceId = resourceId;
      this.uri = null;
      return this;
    ...
    /**
     * Set the stable key to be used instead of the URI or resource lll11l1ll1l1lll1ll1l when caching.
